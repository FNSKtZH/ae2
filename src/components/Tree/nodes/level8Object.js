...
export default ({
  ...
  if (!treeData.level8Object.objectsByParentId) return []
  if (!treeData.level8Object.objectsByParentId.nodes) return []

  return treeData.level8Object.objectsByParentId.nodes.map(node => {
    const childrenCount =
