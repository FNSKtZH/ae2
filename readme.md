...
2. Beziehungs-Sammlungen werden in Eigenschaften-Sammlungen integriert: Es sind einfach Eigenschaften-Sammlungen mit Beziehungen
  ...
  - Beziehungen und Eigenschaften einer Eigenschaften-Sammlung werden am selben Ort angezeigt
...
Die neue Anwendung ist im Aufbau. Zieldatum für die Implementierung: Beginn 2018. Aktueller Stand:
  ...
  - [x] Arten und Lebensräume anzeigen:<br/>![Datenstruktur](/etc/grasfrosch.png?raw=true "Grasfrosch")
    ...
    Hinweis: Eigenschaften und Beziehungen von demselben Objekt zugeordneten synonymen Taxonomie-Objekten sind automatisch verfügbar, da sie am selben Objekt hängen.
  - [ ] Daten exportieren
  - [ ] Login
