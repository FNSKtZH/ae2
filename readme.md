...
- [GraphQL](https://github.com/facebook/graphql) in Form von [PostGraphQL](https://github.com/postgraphql/postgraphql)
  ...
  - GraphQL ist die kommende API-Technologie. Sie ist einfach zu verstehen, extrem leistungsfähig und flexibel. Somit steht ein aussergewöhnlich benutzerfreundlicher API-Server zur Verfügung, mit dem jedermann/-frau ganz nach ihren Bedürfnissen die Daten aus arteigenschaften.ch abgreifen kann. Es wäre sogar möglich - die entsprechenden Benutzerrechte vorausgesetzt - die Daten mit einer beliebigen anderen Software zu bearbeiten.
